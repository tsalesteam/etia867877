...
<div class="ai-actions">
    <button id="ai-generate" class="ai-btn">Generate Content and Edit Image</button>
...
$("#edit-images").on("click", function () {
    ...
    allImageElements.forEach(item => {
        ...
        imageMetaMap.set(item.el, {
            ...
            aspectRatio: item.el.offsetWidth / item.el.offsetHeight,
...
$el.attr("data-original-src", oldSrc);
    ...
    try {
        ...
        if (response.ok) {
            ...
            const aiGeneratedSection = adjacentBlockOfAIGeneratedSection.find(".ai-generated-wrapper");

            const updatedHTML = $("#ai-generated").html();

            aiGeneratedSection.html(updatedHTML);
            document.getElementById("ai-generated").innerHTML = updatedHTML;
...
function updateActionButtons(tab){
    ...
    if(tab === "original"){
        generateBtn.innerText = "Generate Content and Edit Image";
