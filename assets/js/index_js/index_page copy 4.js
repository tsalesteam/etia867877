...
.ai-btn{
    ...
    box-shadow:0 5px 15px rgba(167,55,41,0.18);
}
...
.ai-btn:hover{
    ...
    box-shadow:0 8px 20px rgba(167,55,41,0.25);
}

.ai-btn:active{
    transform:translateY(0);
    box-shadow:0 4px 10px rgba(167,55,41,0.18);
}
...
<div class="ai-modal-content">
    ...
    <div class="ai-tabs">
        <div class="ai-tab active" data-tab="original">
            Original
        </div>

        <div class="ai-tab" data-tab="generated">
            AI Generated
        </div>
    </div>
    ...
    <div class="ai-actions">
        ...
        <div id="original-actions"
            ...
            <button id="generate-content-update-image"
                    class="ai-btn ai-primary-btn">
                Generate Content &amp; Update Image
            </button>

            <button id="update-image"
                    class="ai-btn ai-secondary-btn">
                Update Image
            </button>
        ...
        <div id="generated-actions"
            ...
            <button id="edit-images"
                    class="ai-btn ai-secondary-btn">
                Update Image
            </button>

            <button id="ai-apply"
                    class="ai-btn ai-apply-btn">
                Apply Changes
            </button>
