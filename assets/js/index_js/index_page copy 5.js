...
let currentSection = null;
let generatedText = "";
let originalImageUpdateMode = false;
...
<span id="ai-close-x">×</span>
    ...
    <div class="ai-actions">
        <button id="ai-generate" class="ai-btn">Generate Content and Update Image</button>
...
document.getElementById("ai-generate").onclick = async function () {
    ...
    if($('[data-tab="original"]').hasClass("active")){

        originalImageUpdateMode = true;
        updateActionButtons("original");
...
function updateActionButtons(tab){
    ...
    if(tab === "original"){
        ...
        if(originalImageUpdateMode){
            ...
            generateBtn.innerText = "Update image only";
